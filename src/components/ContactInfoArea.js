               ...
               <div className="row">
                  <div className="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-5 offset-lg-1 col-md-6">
                     <div className="contact__item text-center mb-30 transition-3 white-bg">
                        ...
                        <div className="contact__content">
                           <h3 className="contact__title">About College</h3>
                           <p>Read About College</p>
                           <Link to="/about">
                              <button className="tp-btn tp-btn-border">Read more</button>
                           </Link>
                        </div>
                     </div>
                  </div>
                  <div className="col-xxl-5 col-xl-5  col-lg-5 col-md-6">
                     <div className="contact__item text-center mb-30 transition-3 white-bg">
                        ...
                        <div className="contact__content">
                           <h3 className="contact__title">About Trust</h3>
                           <p>Read About Trust.</p>
                           <Link to="/about-trust">
                              <button className="tp-btn tp-btn-border">Read more</button>
                           </Link>
                        </div>
