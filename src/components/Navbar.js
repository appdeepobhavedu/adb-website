    ...
    return (
      <header>
         <div className="header__area">
                  ...
                  <div className="row align-items-center">
                     <div className="col-xxl-6 col-xl-8 col-lg-8 col-md-8">
                        <div className="header__info">
                           <ul>
                              <li>
                                 <a href="mailto:admissions@adbinstitute.in">
                                    ...
                                    </svg> admissions@adbinstitute.in</a>
                              </li>
                              <li>
                                 <a href="https://goo.gl/maps/S9HvZxTxND4M96z38" target="_blank" rel="noreferrer">
            ...
            <div className={false ? "header__bottom header__sticky" : "header__bottom"} id="header-sticky">
               <div className="container">
                  <div className="row align-items-center">
                        ...
                        <div className="main-menu">
                           <nav id="mobile-menu">
                              <ul>
                                ...
                                <li>
                                  <Link className="navbar-item" to="/about-trust">
                                    About Trust
                                  </Link>
                                </li>
